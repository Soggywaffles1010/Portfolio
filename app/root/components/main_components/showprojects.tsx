...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="md:translate-x-[50%] translate-x-[35%] flex flex-col gap-2 md:text-start md:items-start items-center text-center ">
      {/* Header Text */}
      <div className="w-full flex flex-col gap-1 text-gray-700">
        <p className="font-bold text-5xl min-w-max">Allen Usman</p>
      ...
      <div className="flex gap-5 min-w-max">
        ...
        <button
          ...
          className="py-2 px-5 transition-transform duration-300 hover:scale-105 hover:drop-shadow-[0_0_10px_rgba(255,255,255,1)] flex mt-5 items-center text-gray-700 hover:text-white border rounded-md text-center justify-center border-gray-700 hover:border-white"
        >
